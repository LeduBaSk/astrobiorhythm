...
const settingsTranslations = {
  en: {
    ...
    storyEyebrow: "The Ancient Science",
    storyHeadline: "Where the Stars Meet Your Biology",
    row1Eyebrow: "Celestial Cycles",
    row1Title: "Your Natal Chart, Decoded",
    row1Body: "At the moment of your birth, the planets aligned in a unique configuration that astronomers and mystics alike have studied for millennia. Your natal chart is a precise map of that cosmic moment — a blueprint of your innate strengths, challenges, and karmic path.",
    row2Eyebrow: "Biological Rhythms",
    row2Title: "Three Cycles. Infinite Insight.",
    row2Body: "Biorhythm science, born from 19th-century research by Wilhelm Fliess and Hermann Swoboda, reveals that your physical energy, emotional sensitivity, and intellectual clarity each follow their own mathematical wave. By mapping these three cycles together, you can navigate life's highs and critical crossings with unprecedented awareness.",
    row3Eyebrow: "Multilingual & Free",
    row3Title: "Your Cosmic Mirror — In Your Language",
    row3Body: "AstroBioRhythm is available in 8 languages and is entirely free. Enter your birth data and receive a complete astrological profile — Sun, Moon, and Rising signs — alongside your biorhythm chart and personalized daily horoscope.",
    themes: {
  ...
  sk: {
    ...
    libraryDesc: "Vyberte si znamenie zverokruhu, vstúpte do jeho špecializovanej interaktívnej webovej knihy a preskúmajte jeho históriu, postavenie planét, somatiku a alchémiu.",
    ...
    scrollExplore: "Preskúmať",
    storyEyebrow: "Staroveká veda",
    storyHeadline: "Kde sa hviezdy stretávajú s vašou biológiou",
    row1Eyebrow: "Nebeské cykly",
    row1Title: "Vaša natálna karta, dešifrovaná",
    row1Body: "V momente vášho narodenia sa planéty zoradili do jedinečnej konfigurácie, ktorú astronómovia aj mystici študujú už tisícročia. Vaša natálna karta je presnou mapou tohto vesmírneho okamihu — plánom vašich vrodených silných stránok, výziev a karmickej cesty.",
    row2Eyebrow: "Biologické rytmy",
    row2Title: "Tri cykly. Nekonečné pochopenie.",
    row2Body: "Veda o biorytmoch, zrodená z výskumu Wilhelma Fliessa a Hermanna Swobodu v 19. storočí, odhaľuje, že vaša fyzická energia, emocionálna citlivosť a intelektuálna jasnosť nasledujú vlastnú matematickú vlnu. Spoločným mapovaním týchto troch cyklov sa môžete pohybovať v životných vrcholoch a kritických bodoch s bezprecedentným vedomím.",
    row3Eyebrow: "Viacjazyčné a bezplatné",
    row3Title: "Vaše vesmírne zrkadlo — vo vašom jazyku",
    row3Body: "AstroBioRhythm je k dispozícii v 8 jazykoch a je úplne zadarmo. Zadajte svoje údaje o narodení a získajte kompletný astrologický profil — Slnko, Mesiac a ascendent — spolu s grafom biorytmov a personalizovaným denným horoskopom.",
    themes: {
  ...
  de: {
    ...
    scrollExplore: "Erkunden",
    storyEyebrow: "Die alte Wissenschaft",
    storyHeadline: "Wo Sterne auf Ihre Biologie treffen",
    row1Eyebrow: "Himmlische Zyklen",
    row1Title: "Ihr Geburtshoroskop, entschlüsselt",
    row1Body: "Im Moment Ihrer Geburt standen die Planeten in einer einzigartigen Konstellation, die Astronomen und Mystiker gleichermaßen seit Jahrtausenden erforschen. Ihr Geburtshoroskop ist eine präzise Karte dieses kosmischen Augenblicks – ein Entwurf Ihrer angeborenen Stärken, Herausforderungen und Ihres karmischen Weges.",
    row2Eyebrow: "Biologische Rhythmen",
    row2Title: "Drei Zyklen. Unendliche Einsicht.",
    row2Body: "Die Biorhythmus-Wissenschaft, hervorgegangen aus Forschungen von Wilhelm Fliess und Hermann Swoboda im 19. Jahrhundert, zeigt, dass Ihre körperliche Energie, emotionale Sensibilität und geistige Klarheit jeweils einer eigenen mathematischen Welle folgen. Indem Sie diese drei Zyklen kartieren, können Sie Höhen und kritische Phasen des Lebens mit beispielloser Achtsamkeit meistern.",
    row3Eyebrow: "Mehrsprachig & Kostenlos",
    row3Title: "Ihr kosmischer Spiegel – in Ihrer Sprache",
    row3Body: "AstroBioRhythm ist in 8 Sprachen verfügbar und völlig kostenlos. Geben Sie Ihre Geburtsdaten ein und erhalten Sie ein vollständiges astrologisches Profil – Sonne, Mond und Aszendent – zusammen mit Ihrem Biorhythmus-Diagramm und Ihrem personalisierten Tageshoroskop.",
    themes: {
    ...
    themeTitles: {
      ...
      parchment: "Altes Manuskript (Helles Pergamen)"
    }
  },
  sr: {
    ...
    scrollExplore: "Istraži",
    storyEyebrow: "Drevna Nauka",
    storyHeadline: "Gde se Zvezde Susreću sa Vašom Biologijom",
    row1Eyebrow: "Nebeski Ciklusi",
    row1Title: "Vaša Natalna Karta, Dekodirana",
    row1Body: "U trenutku vašeg rođenja, planete su se poređale u jedinstvenu konfiguraciju koju astronomi i mistici proučavaju već milenijumima. Vaša natalna karta je precizna mapa tog kosmičkog trenutka — nacrt vaših urođenih snaga, izazova i karmičkog puta.",
    row2Eyebrow: "Biološki Ritmici",
    row2Title: "Tri Ciklusa. Beskonačan Uvid.",
    row2Body: "Nauka o bioritmu, rođena iz istraživanja Vilhelma Flisa i Hermana Svobode u 19. veku, otkriva da vaša fizička energija, emocionalna osetljivost i intelektualna jasnost prate sopstveni matematički talas. Mapiranjem ova tri ciklusa zajedno, možete se kretati kroz životne uspone i kritične trenutke sa neviđenom svešću.",
    row3Eyebrow: "Višejezično & Besplatno",
    row3Title: "Vaše Kosmičko Ogledalo — Na Vašem Jeziku",
    row3Body: "AstroBioRhythm je dostupan na 8 jezika i potpuno je besplatan. Unesite podatke o rođenju i primite kompletan astrološki profil — Sunce, Mesec i Podznak — zajedno sa grafikom bioritma i personalizovanim dnevnim horoskopom.",
    themes: {
  ...
  hr: {
    ...
    ambientSoundTitle: "Pusti ambijentalne kozmičke frekvencije (136.1 Hz)",
    scrollExplore: "Istraži",
    storyEyebrow: "Drevna Znanost",
    storyHeadline: "Gdje se Zvijezde Susreću s Vašom Biologijom",
    row1Eyebrow: "Nebeski Ciklusi",
    row1Title: "Vaša Natalna Karta, Dekodirana",
    row1Body: "U trenutku vašeg rođenja, planeti su se poredali u jedinstvenu konfiguraciju koju astronomi i mistici proučavaju već tisućljećima. Vaša natalna karta je precizna mapa tog kozmičkog trenutka — nacrt vaših urođenih snaga, izazova i karmičkog puta.",
    row2Eyebrow: "Biološki Ritmici",
    row2Title: "Tri Ciklusa. Beskonačan Uvid.",
    row2Body: "Znanost o bioritmu, rođena iz istraživanja Wilhelma Fliessa i Hermanna Swobode u 19. stoljeću, odhriva da vaša fizička energija, emocionalna osjetljivost i intelektualna jasnoća prate vlastiti matematički val. Mapiranjem ova tri ciklusa zajedno, možete se kretati kroz životne uspone i kritične trenutke s neviđenom sviješću.",
    row3Eyebrow: "Višejezično & Besplatno",
    row3Title: "Vaše Kozmičko Ogledalo — Na Vašem Jeziku",
    row3Body: "AstroBioRhythm je dostupan na 8 jezika i potpuno je besplatan. Unesite podatke o rođenju i primite kompletan astrološki profil — Sunce, Mjesec i Podznak — zajedno s grafikom bioritma i personaliziranim dnevnim horoskopom.",
    themes: {
      platinum: "Analitička platina",
      earth: "Micelijum i žad",
      clay: "Glinena posuda",
  ...
  fr: {
    ...
    scrollExplore: "Explorer",
    storyEyebrow: "La science ancienne",
    storyHeadline: "Quand les étoiles rencontrent votre biologie",
    row1Eyebrow: "Cycles célestes",
    row1Title: "Votre thème natal, décodé",
    row1Body: "Au moment de votre naissance, les planètes se sont alignées dans une configuration unique que les astronomes et les mystiques étudient depuis des millénaires. Votre thème natal est une carte précise de ce moment cosmique — un plan de vos forces innées, de vos défis et de votre chemin karmique.",
    row2Eyebrow: "Rythmes biologiques",
    row2Title: "Trois cycles. Un aperçu infini.",
    row2Body: "La science du biorythme, née des recherches de Wilhelm Fliess et Hermann Swoboda au XIXe siècle, révèle que votre énergie physique, votre sensibilité émotionnelle et votre clarté intellectuelle suivent chacune leur propre onde mathématique. En cartographiant ces trois cycles ensemble, vous pouvez naviguer à travers les hauts et les passages critiques de la vie avec une conscience sans précédent.",
    row3Eyebrow: "Multilingue & Gratuit",
    row3Title: "Votre miroir cosmique — dans votre langue",
    row3Body: "AstroBioRhythm est disponible en 8 langues et est entièrement gratuit. Entrez vos données de naissance et recevez un profil astrologique complet — signes du Soleil, de la Lune et de l'Ascendant — ainsi que votre graphique de biorythme et votre horoscope quotidien personnalisé.",
    themes: {
  ...
  hu: {
    ...
    scrollExplore: "Felfedezés",
    storyEyebrow: "Az ősi tudomány",
    storyHeadline: "Ahol a csillagok találkoznak a biológiával",
    row1Eyebrow: "Mennyei ciklusok",
    row1Title: "Születési kéleted, megfejtve",
    row1Body: "Születésed pillanatában a bolygók egy olyan egyedi konfigurációban álltak össze, amelyet csillagászok és misztikusok egyaránt évezredek óta tanulmányoznak. Születési kéleted ennek a kozmikus pillanatnak a pontos térképe — veleszületett erősségeid, kihívásaid és karmikus utad tervrajza.",
    row2Eyebrow: "Biológiai ritmusok",
    row2Title: "Három ciklus. Végtelen felismerés.",
    row2Body: "A bioritmus tudománya, amely Wilhelm Fliess és Hermann Swoboda 19. századi kutatásaiból született, feltárja, hogy fizikai energiád, érzelmi érzékenységed és szellemi tisztánlátásod mind saját matematikai hullámot követ. E három ciklus együttes ábrázolásával soha nem látott tudatossággal navigálhatsz az élet csúcspontjain és kritikus pontjain.",
    row3Eyebrow: "Többnyelvű és ingyenes",
    row3Title: "Kozmikus tükröd — a te nyelveden",
    row3Body: "Az AstroBioRhythm 8 nyelven érhető el és teljesen ingyenes. Add meg születési adataidat, és kapj egy teljes asztrológiai profilt — Nap, Hold és Aszcendens jegyekkel —, valamint bioritmus-diagramot és személyre szabott napi horoszkópot.",
    themes: {
    ...
    themeTitles: {
      ...
      clay: "Agyag edény (Réz, terakota és bronza)",
  ...
  it: {
    ...
    menuResults: "Il mio profilo astrologico",
    ...
    scrollExplore: "Esplora",
    storyEyebrow: "L'antica scienza",
    storyHeadline: "Dove le stelle incontrano la tua biologia",
    row1Eyebrow: "Cicli celesti",
    row1Title: "La tua carta natale, decodificata",
    row1Body: "Al momento della tua nascita, i pianeti si sono allineati in une configurazione unica che astronomi e mistici studiano da millenni. La tua carta natale è una mappa precisa di quel momento cosmico: una traccia delle tue forze intestate, delle tue sfide e del tuo percorso karmico.",
    row2Eyebrow: "Ritmi biologici",
    row2Title: "Tre cicli. Intuizione infinita.",
    row2Body: "La scienza del bioritmo, nata dalle ricerche del XIX secolo di Wilhelm Fliess e Hermann Swoboda, rivela che la tua energia fisica, la sensibilità emotiva e la chiarezza intellettuale seguono ciascuna la propria onda matematica. Mappando insieme questi tre cicli, puoi navigare tra gli alti e i passaggi critici della vita con una consapevolezza senza precedenti.",
    row3Eyebrow: "Multilingue e gratuito",
    row3Title: "Il tuo specchio cosmico — nella tua lingua",
    row3Body: "AstroBioRhythm è disponibile in 8 lingue ed è completamente gratuito. Inserisci i tuoi dati di nascita e ricevi un profilo astrologico completo — segni del Sole, della Luna e dell'Ascendente — insieme al tuo grafico del bioritmo e all'oroscopo giornaliero personalizzato.",
    themes: {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const birthStateVal = document.getElementById("birthState").value.trim();
  const birthCityVal = document.getElementById("birthCity").value.trim();
  
  const isProfileComplete = nameVal && emailVal && birthDateVal && birthTimeVal && birthStateVal && birthCityVal;

  if (!state.lastCalculation) {
    if (hasSavedProfile && isProfileComplete) {
      if (coverPage) coverPage.classList.add("hidden");
      if (formCard) formCard.classList.add("hidden");
      if (resultsCard) {
        resultsCard.style.display = "block";
    ...
    } else if (hasSavedProfile && !isProfileComplete) {
      // Profile exists but location is missing. Show form so they can complete it without errors.
      if (coverPage) coverPage.classList.add("hidden");
      if (formCard) formCard.classList.remove("hidden");
      if (resultsCard) {
        resultsCard.style.display = "none";
...
function updateLanguage() {
  ...
  // Update scroll explorer & editorial story
  const scrollExploreEl = document.getElementById("scroll-explore-text");
  const storyEyebrowEl = document.getElementById("story-eyebrow-text");
  const storyHeadlineEl = document.getElementById("story-headline-text");
  
  const row1EyebrowEl = document.getElementById("row1-eyebrow");
  const row1TitleEl = document.getElementById("row1-title");
  const row1BodyEl = document.getElementById("row1-body");
  
  const row2EyebrowEl = document.getElementById("row2-eyebrow");
  const row2TitleEl = document.getElementById("row2-title");
  const row2BodyEl = document.getElementById("row2-body");
  
  const row3EyebrowEl = document.getElementById("row3-eyebrow");
  const row3TitleEl = document.getElementById("row3-title");
  const row3BodyEl = document.getElementById("row3-body");

  if (scrollExploreEl && sLang.scrollExplore) scrollExploreEl.textContent = sLang.scrollExplore;
  if (storyEyebrowEl && sLang.storyEyebrow) storyEyebrowEl.textContent = sLang.storyEyebrow;
  if (storyHeadlineEl && sLang.storyHeadline) storyHeadlineEl.textContent = sLang.storyHeadline;
  
  if (row1EyebrowEl && sLang.row1Eyebrow) row1EyebrowEl.textContent = sLang.row1Eyebrow;
  if (row1TitleEl && sLang.row1Title) row1TitleEl.textContent = sLang.row1Title;
  if (row1BodyEl && sLang.row1Body) row1BodyEl.textContent = sLang.row1Body;
  
  if (row2EyebrowEl && sLang.row2Eyebrow) row2EyebrowEl.textContent = sLang.row2Eyebrow;
  if (row2TitleEl && sLang.row2Title) row2TitleEl.textContent = sLang.row2Title;
  if (row2BodyEl && sLang.row2Body) row2BodyEl.textContent = sLang.row2Body;
  
  if (row3EyebrowEl && sLang.row3Eyebrow) row3EyebrowEl.textContent = sLang.row3Eyebrow;
  if (row3TitleEl && sLang.row3Title) row3TitleEl.textContent = sLang.row3Title;
  if (row3BodyEl && sLang.row3Body) row3BodyEl.textContent = sLang.row3Body;
  ...
  // Update results section if calculation was done (regardless of current visibility)
  if (state.lastCalculation) {
...
function updateResultsLanguage() {
  ...
  // Translate dynamically calculated astrological profile contents
  if (state.lastCalculation) {
    const { birthDate, astroData, bioData } = state.lastCalculation;
    
    // Update translated user birth date
    const userBirthDateElement = document.getElementById("userBirthDate");
    if (userBirthDateElement && birthDate) {
    ...
    // Update translated sign names inside the badge HTML
    const sunSignBadge = document.getElementById("sunSign");
    const moonSignBadge = document.getElementById("moonSign");
    const risingSignBadge = document.getElementById("risingSign");
    
    const sunSymbol = zodiacSymbols[astroData.sunSign] || "";
    const moonSymbol = zodiacSymbols[astroData.moonSign] || "";
    const risingSymbol = zodiacSymbols[astroData.risingSign] || "";
    
    if (sunSignBadge) {
      sunSignBadge.innerHTML = `<span class="zodiac-symbol">${sunSymbol}</span> ${getTranslatedZodiacSign(astroData.sunSign)}`;
    }
    if (moonSignBadge) {
      moonSignBadge.innerHTML = `<span class="zodiac-symbol">${moonSymbol}</span> ${getTranslatedZodiacSign(astroData.moonSign)}`;
    }
    if (risingSignBadge) {
      risingSignBadge.innerHTML = `<span class="zodiac-symbol">${risingSymbol}</span> ${getTranslatedZodiacSign(astroData.risingSign)}`;
    }
    ...
    if (sunSignStoryElement) sunSignStoryElement.textContent = getZodiacStory(astroData.sunSign, "sun");
    if (moonSignStoryElement) moonSignStoryElement.textContent = getZodiacStory(astroData.moonSign, "moon");
    if (risingSignStoryElement) risingSignStoryElement.textContent = getZodiacStory(astroData.risingSign, "rising");
    ...
    if (loveHoroscopeElement) loveHoroscopeElement.textContent = getZodiacStory(astroData.sunSign, "love");
    if (careerHoroscopeElement) careerHoroscopeElement.textContent = getZodiacStory(astroData.sunSign, "career");
    if (healthHoroscopeElement) healthHoroscopeElement.textContent = getZodiacStory(astroData.sunSign, "health");
    ...
    if (personalityTraitsElement) personalityTraitsElement.textContent = getZodiacStory(astroData.sunSign, "traits");
    if (strengthsElement) strengthsElement.textContent = getZodiacStory(astroData.sunSign, "strengths");
    if (challengesElement) challengesElement.textContent = getZodiacStory(astroData.sunSign, "challenges");
    
    // Update translated biorhythm description sentences
    ...
    if (physicalDesc && bioData.physical) {
      physicalDesc.textContent = getBiorhythmDescription(bioData.physical.value, "physical");
    }
    if (emotionalDesc && bioData.emotional) {
      emotionalDesc.textContent = getBiorhythmDescription(bioData.emotional.value, "emotional");
    }
    if (intellectualDesc && bioData.intellectual) {
      intellectualDesc.textContent = getBiorhythmDescription(bioData.intellectual.value, "intellectual");
    }
  }
}
...
async function geocodeLocationFree(location) {
  try {
    ...
    try {
      ...
      console.warn("Geocoding failed, using default regional coordinates:", fallbackError);
      // Fallback to Belgrade/Zagreb region coords so calculation never blocks
      return {
        lat: 44.8156,
        lng: 20.4633,
        formatted: `${location} (Estimated regional alignment)`,
        country: 'Serbia',
        city: location
      };
    }
...
class CustomDatePicker {
  ...
  show() {
    ...
    if (CustomTimePicker.activePicker) {
...
class CustomTimePicker {
  ...
  init() {
    ...
    // Number input changes (allow typing & clearing)
    this.hourInput.addEventListener('input', (e) => {
      const val = e.target.value;
      if (val === '') return;
      const parsed = parseInt(val, 10);
      if (!isNaN(parsed)) {
        this.currentHour = Math.max(1, Math.min(12, parsed));
    ...
    this.minuteInput.addEventListener('input', (e) => {
      ...
      const parsed = parseInt(val, 10);
      if (!isNaN(parsed)) {
        this.currentMinute = Math.max(0, Math.min(59, parsed));
  ...
  setupClockInteractions() {
    ...
    const startDrag = (e) => {
      ...
      const getMinDiff = (a, b) => {
        let diff = Math.abs(a - b) % 360;
        return diff > 180 ? 360 - diff : diff;
      };
      
      const hourDiff = getMinDiff(angle, hourAngle);
      const minuteDiff = getMinDiff(angle, minuteAngle);
      ...
      isDragging = true;
      this.picker.classList.add('dragging');
      this.updateDisplay();
    };
    ...
    const stopDrag = () => {
      isDragging = false;
      dragTarget = null;
      this.picker.classList.remove('dragging');
    };
  ...
  show() {
    ...
    if (CustomDatePicker.activePicker) {
      CustomDatePicker.activePicker.hide();
    }
  ...
  hide() {
    this.isOpen = false;
    if (CustomTimePicker.activePicker === this) {
  ...
  updateDisplay(skipHour = false, skipMinute = false) {
    // Update clock hands
